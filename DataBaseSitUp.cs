...
namespace Fitness
{
    class DataBaseSitUp
    {
        ...
        public DataBaseSitUp(int id, double first_approach, double second_approach, double third_approach, double fourth_approach, double fiveth_approach, string date)
        {
            Id = id;
