...
namespace Fitness
{
    class DataBaseSitUp
    {
        public DataBaseSitUp()
        {

        }
        public DataBaseSitUp(int id, string first_approach, string second_approach, string third_approach, string fourth_approach, string fiveth_approach, string date)
        {
            Id = id;
