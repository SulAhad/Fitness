...
namespace Fitness
{
    class DataBasePushUp
    {
        ...
        public DataBasePushUp(int id, double first_approach, double second_approach, double third_approach, double fourth_approach, double fiveth_approach, string date)
        {
            Id = id;
